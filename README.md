...
- [Playbook AWS para datos reales](#playbook-aws-para-datos-reales)
...
## Playbook AWS para datos reales

Para una ejecución segura en EC2 con snapshot + volumen temporal:
...
Ver detalle completo en [`docs/AWS_FORENSIC_PLAYBOOK.md`](docs/AWS_FORENSIC_PLAYBOOK.md).
